...
;( function( window ) {
	...
	cbpTooltipMenu.prototype = {
		...
		_init : function() {
			...
			this.menuItems = document.querySelectorAll( '#' + this.el.id + ' .cbp-tm-submenu-parent' );
			this._initEvents();
		},
		_initEvents : function() {
			...
			Array.prototype.slice.call( this.menuItems ).forEach( function( el, i ) {
				var trigger = el;
				//console.log(el.querySelector( '.ratnarai-label' ));
				...
				if( false && self.touch ) {
					...
					trigger.addEventListener( 'mouseover', function(ev) { if( isMouseLeaveOrEnter( ev, this ) ) self._openMenu( this ); } );
					trigger.addEventListener( 'mouseout', function(ev) { if( isMouseLeaveOrEnter( ev, this ) ) self._closeMenu( this ); } );
				}
			} );
